  ...
  return (
    <AuthLayout title="Sign Up | Moolre">
      <>
        ...
        <div className="mt-10 lg:mt-8 lg:border lg:w-4/12 lg:rounded-md xl:roun lg:px-10 2xl:px-12 lg:py-6 2xl:w-3/12">
          <div className="">
            <AuthInput
              inputName="email"
              label="Email Address"
          ...
          <div className="mt-7 lg:mt-3">
            ...
            <select
              className="py-2 px-2 border w-full rounded-md"
              value={userType}
